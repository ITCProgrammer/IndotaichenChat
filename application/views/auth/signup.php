					...
					<form autocomplete="off" id="form_signup" enctype="multipart/form-data">
						...
						<div class="field_container">
							<div class="row">
								...
								<div class="form-group col-lg-6">
								<input type="text" name="txt_lname" id="lname" placeholder="Dept/Bagian" class="form-control">
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="form-group col-lg-6">
									<input type="text" name="absen" placeholder="Absen" class="form-control" id="absen">
								</div>
								<div class="form-group col-lg-6">
									<input type="text" name="dpt" placeholder="Departemen" class="form-control" id="dpt"oninput="this.value = this.value.toUpperCase()">
								</div>
							</div>
